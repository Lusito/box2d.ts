...
function submergedAreaForPolygon(
    shape: b2Shape,
    normal: b2Vec2,
    offset: number,
...
function submergedAreaForChain(
    shape: b2Shape,
    _normal: b2Vec2,
    _offset: number,
    _xf: b2Readonly<b2Transform>,
...
function submergedAreaForCircle(
    shape: b2Shape,
    normal: b2Vec2,
    offset: number,
    xf: b2Readonly<b2Transform>,
...
export function b2SubmergedAreaForShape(
    shape: b2Shape,
    normal: b2Vec2,
    offset: number,
    xf: b2Readonly<b2Transform>,
